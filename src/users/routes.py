...
from src.users.forms import RegistrationForm, LoginForm,UpdateAccountForm,RequestResetForm,ResetPasswordForm
...
def login():
    ...
    if form.validate_on_submit():
        ...
        #if a user exists, check their password,we can also use Werkzeug.security
